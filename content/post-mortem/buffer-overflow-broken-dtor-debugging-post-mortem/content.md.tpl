...
{{view:file=main.cpp,start=13,end=38}}
...
{{view:file=main.cpp,start=105,end=107}}

스크립트 파일로부터 명령을 한줄씩 읽는 함수입니다. 읽은 내용은 `cmd_`,
`name_`, `text_` 에 저장합니다.

{{view:file=main.cpp,start=107,end=131}}
...
{{view:file=main.cpp,start=132,end=153}}
...
{{view:file=main.cpp,start=154,end=156}}

더이상 파싱할수 없으면 스크립트가 끝났다는걸 알려줍니다.

{{view:file=main.cpp,start=157,end=170}}
...
{{view:file=main.cpp,start=30,end=34}}
