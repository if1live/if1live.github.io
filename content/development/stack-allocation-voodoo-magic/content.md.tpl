...
{{view:file=inf_loop_bug.c,start=4,end=25}}
...
{{view:file=inf_loop_bug.c,start=26,end=48}}
...
{{view:file=for_each_functor.cpp}}

C++11 부터는 lambda가 있어서 functor를 쓰지 않아도 된다. 나머지는
동일하다.

{{view:file=for_each_lambda.cpp}}
...
{{view:file=enhanced_for_loop.cpp}}
