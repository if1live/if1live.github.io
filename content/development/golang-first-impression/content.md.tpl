...
{{view:file=indent.cs,lang=csharp}}
...
{{view:file=data_structure.cs,lang=csharp}}

{{view:file=data_structure.go}}
...
{{view:file=no_generic.java,lang=java}}
...
{{execute:cmd=go run rtti.go,attach_cmd=true}}
...
{{view:file=private.rb}}

public/private 의 개념을 설명하고자 구현한 루비 예제이다.

{{execute:cmd=ruby private.rb,attach_cmd=true}}
...
{{view:file=private.py}}

{{execute:cmd=python private.py,attach_cmd=true}}
...
{{view:file=private/private.go}}

{{view:file=private_main.go}}
...
{{view:file=call_by_xxx.cs,lang=csharp}}
...
{{view:file=call_by_xxx.go}}

{{execute:cmd=go run call_by_xxx.go,attach_cmd=true}}
...
{{view:file=broken_goroutine.go}}

{{execute:cmd=go run broken_goroutine.go,attach_cmd=true}}
