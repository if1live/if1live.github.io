...
{{view:file=default_argument.py}}

{{view:file=default_argument.rb}}

{{execute:cmd=python default_argument.py,attach_cmd=true}}

{{execute:cmd=ruby default_argument.rb,attach_cmd=true}}
...
{{view:file=initial.py}}

{{view:file=initial.rb}}

{{execute:cmd=python initial.py,attach_cmd=true}}

{{execute:cmd=ruby initial.rb,attach_cmd=true}}
