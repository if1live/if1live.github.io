...
{{view:file=alternative_strongly_typed.cs,lang=csharp}}
...
{{view:file=alternative_operator_precedence.py}}

{{execute:cmd=python alternative_operator_precedence.py,attach_cmd=true}}
