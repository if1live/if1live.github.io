...
{{view:file=main.c,start=15,end=18}}
...
{{view:file=simple_macro.h,start=3,end=4}}
...
{{view:file=variable_is_macro.h,start=3,end=5}}

{{view:file=variable_is_macro.c,start=2,end=3}}
...
{{view:file=function_is_macro.h,start=3,end=7}}

{{view:file=function_is_macro.c,start=2,end=3}}

{{view:file=main.c,start=2,end=15}}
...
{{view:file=simple_asm.s,start=9,end=15}}
...
{{view:file=variable_asm.s,start=9,end=16}}

`movl  g_foo(%rip), %esi`, `addl  $123, %esi` 를 볼때 변수를 읽어서 123을 더하는 작업을 수행한다.

### 매크로와 함수를 연결

{{view:file=function_asm.s,start=9,end=18}}
