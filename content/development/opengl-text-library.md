...
![glutStrokeString](|filename|../static/opengl_text_library/glutstroke.png)
...
![vincent](|filename|../static/opengl_text_library/vincent.png)
...
![small font](|filename|../static/opengl_text_library/small.png)

### AntTweakBar 중간 폰트

![normal font](|filename|../static/opengl_text_library/normal.png)

### AntTweakBar 큰 폰트

![large font](|filename|../static/opengl_text_library/large.png)

### AntTweakBar 고정폭

![fixed font](|filename|../static/opengl_text_library/fixed.png)

## OpenGL Text Library

적당히 만들어본 라이브러리이다.

* [Exe and Source](|filename|../static/opengl_text_library/text_label.zip)
* [Repo][textlabel_repo]


![fixed font](|filename|../static/opengl_text_library/demo.png)
